      ...
      <Section>
        <div className="text-center">
          ...
          <div className="whitespace-pre-line text-4xl font-bold text-gray-900">
            <Grid container spacing={1}>
              <Grid item xs={3} md={2}>
                <div className="flex h-full items-center justify-end pr-2 text-sm">
                  Output Format
                </div>
              </Grid>
              <Grid item xs={9} md={10}>
                <CategorySelectionTab
                  categories={outputFormats}
                  selectedCategory={outputFormat}
                  setCategory={setOutputFormat}
                  color={red[600]}
                />
              </Grid>
            </Grid>
          ...
          <div className="whitespace-pre-line text-4xl font-bold text-gray-900">
            <Grid container spacing={1}>
              ...
              <Grid item xs={9} md={10}>
                <CategorySelectionTab
                  categories={timeWindows}
                  selectedCategory={timeWindow}
                  setCategory={setTimeWindow}
                  color={blue[600]}
                />
              </Grid>
            </Grid>
        ...
        <div className="my-4">
          <CodeSnippet
            code={GetSnippets(outputFormat, language, timeWindow, industry)}
          />
        </div>
        <div className="text-center">
          <ContactUs />
